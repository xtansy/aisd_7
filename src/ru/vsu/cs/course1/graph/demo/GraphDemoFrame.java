    ...
    public GraphDemoFrame() {
        ...
        buttonCreateGraph.addActionListener(e -> {
            try {
                ...
                panelGraphPainter.paint(dotToSvg(GraphUtils.toDot(graph, new ArrayList<>())));
            } catch (Exception exc) {
                SwingUtils.showErrorMessageBox(exc);
            }
        });
        ...
        taskButton.addActionListener(e -> {
            try {
                ...
                showSystemOut(() -> {
                    int from = (int) spinnerFromVertex.getValue();
                    try {
                        panelGraphPainter.paint(dotToSvg(GraphUtils.toDot(graph, GraphAlgorithms.taskWithDFS(graph, from))));
                    } catch (IOException ex) {
                        ex.printStackTrace();
                    }
                    System.out.println(GraphAlgorithms.taskWithDFS(graph, from));
                });
            } catch (Exception exc) {
                SwingUtils.showErrorMessageBox(exc);
            }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel4.add(panel5, new GridConstraints(2, 0, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        panel4.add(panel6, new GridConstraints(3, 0, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        taskButton.setText("taskButton");
        panel4.add(taskButton, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
